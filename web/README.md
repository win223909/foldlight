...
Serve the output over HTTPS to enable phone motion. Use your own static host; no backend is needed. Platform download links point to hosted binaries rather than requiring installers in the checkout.
